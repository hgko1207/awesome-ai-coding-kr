...
| 도구 | 한 줄 평 | 평가 | ⭐ | 상태 |
|---|---|---|---|---|
| [Claude Code](https://www.anthropic.com/claude-code) ✅ 🔥 | VSCode에 붙여 매일 쓰는 주력. 플랜 짜기·아이디어 생성·바이브코딩에 특히 강하다. | ★★★★★ | 141.2k | 🟢 |
...
| [OpenHands](https://www.all-hands.dev) | 구 OpenDevin. 샌드박스에서 자율로 코드를 작성·실행하는 오픈소스 에이전트. | 미사용 | 83.8k | 🟢 |
...
| [OpenAI Codex CLI](https://developers.openai.com/codex) 🔥 | OpenAI 공식 터미널 코딩 에이전트. Claude Code의 OpenAI 진영 대응. | 미사용 | 105.6k | 🟢 |
...
| [Goose](https://block.github.io/goose) | Block(스퀘어)이 만든 오픈소스 에이전트. MCP 기반 확장이 자유로움. | 미사용 | 52.7k | 🟢 |
...
| [Zed](https://zed.dev) 🔥 | Rust로 만든 초고속 에디터. AI 에이전트 패널을 기본 내장. | 미사용 | 88.5k | 🟢 |
